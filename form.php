        ...
        <form method="post" action="">
            <?php foreach ($list_soal as $key => $soal): ?>
                <div class="soal">
                    ...
                    <div class="jawaban">
                        <input type="radio" name="soal_<?= $key ?>" value="A" required> A. <?= $soal['jawaban']['A'] ?><br>
                        <input type="radio" name="soal_<?= $key ?>" value="B" required> B. <?= $soal['jawaban']['B'] ?><br>
                        <input type="radio" name="soal_<?= $key ?>" value="C" required> C. <?= $soal['jawaban']['C'] ?><br>
                        <input type="radio" name="soal_<?= $key ?>" value="D" required> D. <?= $soal['jawaban']['D'] ?>
                    </div>
                </div>
            <?php endforeach; ?>
